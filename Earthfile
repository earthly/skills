...
install-skills:
    ...
    RUN rm -rf $CODEX_HOME/skills/earthfile $CODEX_HOME/skills/lunar-cataloger $CODEX_HOME/skills/lunar-collector $CODEX_HOME/skills/lunar-policy $CODEX_HOME/skills/lunar-sql
