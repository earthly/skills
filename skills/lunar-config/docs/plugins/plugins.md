...
👉 [Learn more about Cataloger Plugins](cataloger-plugins.md)

### Collectors

Collectors gather metrics and data from your components.

👉 [Learn more about Collector Plugins](collector-plugins.md)

### Policies

Policies define rules and standards for your components.

👉 [Learn more about Policy Plugins](policy-plugins.md)
