...
- **Already there** — tell the user what you found and let them choose: "a Terraform collector already exists at `github.com/earthly/lunar-lib/collectors/terraform` — should we use that instead?"
